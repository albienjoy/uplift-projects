    ...
    <div>
      <div>
        {data.map((race) => (
          <div
            key={race.id}
            className='border-2 border-lime m-5 p-5 rounded-xl'
          >
            <div className='text-xl sm:text-md font-bold'>{race.name.en}</div>
            <div>
              {" "}
              <b>City: </b>
              {race.city}
            ...
            <div className='overflow-hidden'>{race.url}</div>
